...
Oxford City has adopted the Service Standard as part of its [Digital Strategy]({site:url}/strategy/index.html), and our [Digital Design Standards]({site:url}/standards/lgdss.html) also use this to alert potential suppliers to how we want to work with them in the future.
